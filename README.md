...
|---|-------------|----------|----------|
| 1 | [SavvasRaptis/helio-data-methods](https://github.com/SavvasRaptis/helio-data-methods) | 2 | Уроки и воспроизводимые примеры статистического моделировани... |

📦 **Архив всех проектов**: [links/ai_links_filtered_20260811_105435.md](links/ai_links_filtered_20260811_105435.md)
