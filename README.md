...
| Репозиторий | ⭐️ Звёзды | Описание |
|-------------|-----------|-----------|
| [diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute) | 4271 | Never stop coding. Free AI gateway: one endpoint, 160+ provi... |
| [romgX/openrelay](https://github.com/romgX/openrelay) | 1863 | 几百个免费 AI 模型配额，一键接入本地项目。| Hundreds of free AI model quotas, o... |
...
| [ShaikhWarsi/free-ai-tools](https://github.com/ShaikhWarsi/free-ai-tools) | 250 | Curated list of free and low cost AI tools, LLM APIs, IDEs, ... |
